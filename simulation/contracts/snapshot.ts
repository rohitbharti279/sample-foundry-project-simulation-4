...
import { takecounterContractSnapshot } from "./counter_snapshot.ts";
...
export class ContractSnapshotProvider implements SnapshotProvider {
    ...
    async snapshot(): Promise<Snapshot> {   
        ...
        contractSnapshot["counter"] = await takecounterContractSnapshot(this.contracts.counter, this.actors);
