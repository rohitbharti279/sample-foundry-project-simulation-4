...
export class DeployCounterAction extends Action {
    ...
    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for DeployCounter action..");
