...
export class IncrementTheNumberAction extends Action {
    private contract: any;
    constructor(contract: any) {
        super("IncrementTheNumber");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for IncrementTheNumber action..");
