...
export class ReceiveInitialTokenSupplyAction extends Action {
    private contract: any;
    constructor(contract: any) {
        super("ReceiveInitialTokenSupply");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for ReceiveInitialTokenSupply action..");
