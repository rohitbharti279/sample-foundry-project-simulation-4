...
export class DeployCounterContractAction extends Action {
    private contract: any;
    constructor(contract: any) {
        super("DeployCounterContract");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for DeployCounterContract action..");
